...
Notes:
- Uses /v1/responses via Batch API with JSON mode (response_format=json_object).
...
TEXT_FORMAT_JSON_OBJECT = {"type": "json_object"}
        ...
        for user_dir in users:
            ...
            for sess_idx, chat_path in chats:
                ...
                body = {
                    ...
                    "text": {"format": TEXT_FORMAT_JSON_OBJECT},
                    "store": store,
                }
