...
class ChatAgent:
    ...
    def _build_system_prompt(
        ...
        if user_info_state:
            ...
            occupation = user_info_state.get("occupation") or "unknown occupation"
        ...
        # Latest goals feedback, if any
        if goals_feedback:
            fb_text = "Latest goal feedback from the user:\n" + goals_feedback
            context_parts.append(fb_text)
    ...
    def build_messages(
        ...
        system_content = self._build_system_prompt(user_state, user_info_state, goals_feedback)
    ...
    def reply(
        ...
        messages = self.build_messages(user_input, user_state, user_info_state, goals_feedback)
